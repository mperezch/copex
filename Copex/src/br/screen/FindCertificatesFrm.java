...
public class FindCertificatesFrm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 280, 57, 33));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindCertificatesFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
